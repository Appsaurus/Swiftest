...
//    ///
//    /// - Note: Note that this property does not validate the email address
//    /// against an email server. It merely attempts to determine whether its
//    /// format is suitable for an email address.
//    ///
